import argparse
import torch
from model import MultiEsenNICModel
import pycocotools
...
def main(params):
	...
	multiesen = MultiEsenNICModel(argparse.Namespace(**params))
	multiesen.load_state_dict(torch.load(params['checkpoint']))
	multiesen.cuda()
	multiesen.eval()
	...
	loss, result, scores = evaluate(multiesen, build_model, homogeneousdata, params)
